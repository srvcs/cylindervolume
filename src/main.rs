use srvcs_cylindervolume::{api::Deps, config::Config, health, router, telemetry};
...
async fn main() {
    ...
    tracing::info!(addr = %cfg.bind_addr, env = %cfg.environment, "srvcs-cylindervolume listening");
    let deps = Deps {
